...
\begin{frame}{Topics}
    ...
    \begin{enumerate}
        ...
        \vspace{0.5em}
        \item Repurposing AI software and hardware
        \vspace{0.5em}
...
\begin{frame}
    ...
    The aim of this lectures is \textbf{limited}
...
\begin{frame}
    ...
    \begin{itemize}
        \item enhanced efficiency in data centers and chip design
        \vspace{0.5em}
...
\begin{frame}[fragile]
    ...
    \begin{itemize}
        \item Multithreading over local GPU cores / compute units 
    \end{itemize}
...
\begin{frame}
    ...
    \vspace{0.5em}
    At GTC 2025, NVIDIA announced native support for Python in CUDA toolkit


    \vspace{0.5em}
    `Pythonic reimagining of the CUDA runtime to be naturally and natively Python.''
